globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/OrbitGame-CXEctOlz.js","assets/three.module-Ae2Kw8zd.js","assets/layout-segment-context-CArnHBxY.js"];
...
function getDraftSecret() {
	return "a7632a39-627b-470f-8857-2fcf0062a6df";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a56ee565-6f28-4cc0-bcff-ca4ff2d9cd2f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a56ee565-6f28-4cc0-bcff-ca4ff2d9cd2f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a56ee565-6f28-4cc0-bcff-ca4ff2d9cd2f",
		rootBoundaryId
	});
}
/**
...
var OrbitGame_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "8c4056f5b716", "default");
//#endregion
//#region app/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(OrbitGame_default, {});
}
...
async function generateMetadata() {
	...
	const description = "Command gravity-assisted rescue flights across humanity's frontier systems in 2300 AD.";
	return {
		title,
		description,
		openGraph: {
